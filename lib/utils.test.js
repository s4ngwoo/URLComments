...
describe('URLComments Utils', () => {
  describe('normalizeUrl', () => {
    ...
    it('should preserve paths and remove trailing slash if not root', () => {
      expect(normalizeUrl('https://namu.wiki/w/문서')).toBe('https://namu.wiki/w/%EB%AC%B8%EC%84%9C');
    ...
    it('should filter chrome and internal URLs', () => {
      ...
      expect(normalizeUrl('file:///Users/local/file.txt')).toBeNull();
    });
