...
모든 웹 페이지에 나만의 의견을 남기고, 다른 사람들의 생각을 확인할 수 있는 크롬 확장 프로그램입니다. 기사, 블로그, 쇼핑몰 등 URL이 있는 곳이라면 어디서든 자유롭게 소통해보세요.

## 1. 프로젝트 소개
- **서비스 컨셉:** 웹상의 모든 URL을 하나의 소통 공간으로 만들어, 해당 페이지에 대한 의견을 자유롭게 남기고 공유하는 소셜 주석 도구.
- **MVP 기능:** 
